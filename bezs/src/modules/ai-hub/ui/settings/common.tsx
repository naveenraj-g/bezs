...
export const CommonSettings = () => {
  ...
  return (
    <div className="flex flex-col items-start pr-2 pb-4 gap-2 h-full overflow-y-auto no-scrollbar">
      <p className="text-base font-medium py-4">Default Settings</p>
      ...
      <div className="flex flex-row items-end justify-between w-full">
        <p className="text-xs text-zinc-500 dark:text-zinc-300">Temperature</p>
        <Button
          variant="secondary"
          size="sm"
          onClick={() => {
      ...
      <div className="flex flex-col gap-2 justify-between w-full p-3 bg-white/40 dark:bg-white/8 rounded-xl">
        ...
        <p className="text-xs text-zinc-500 dark:text-zinc-300">
          ...
          probability mass re considered.
        </p>
      </div>
      ...
      <div className="flex flex-col gap-2 justify-between w-full p-3 bg-white/40 dark:bg-white/8 rounded-xl">
        ...
        <p className="text-xs text-zinc-500 dark:text-zinc-300">
          An alternative to sampling with temperature, called nucleus sampling,
          where the model considers the results of the tokens with top_k
          probability mass. so 0.1 means only the tokens comprising the top 10%
          probability mass re considered.
        </p>
      </div>
